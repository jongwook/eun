...
(function (s06) {
    (function (preexam) {
        preexam.html = '<div id="slide" class="large-text">	<div ng-show="vm.page == 4">		<p style="text-align: center;">			과제를 통한 새로운 학습방법으로 <span class="big green">재미있게</span> 학습해 보세요.<br><br>			<button ng-click="vm.next()" style="width: 600px; height: 50px; background-color: green; color: white; font-size: 18pt; border: 0;">				고사성어 학습하기			</button>		</p>	</div>	<div ng-show="vm.page == 0">		<p>			오늘 여러분이 학습할 고사성어는 중학교 국어 및 한문 교과서에서 자주 다루는 수업 내용으로			<span class="green">&quot;중학생이 꼭 알아야 할 고사성어&quot;</span>로 선정되어 있으며			전국적으로 실시되는 하업능력평가에서도 많은 비중을 차지하기 때문에 고사성어를 학습하는 것은 매우 중요합니다.		</p>		<p>			지난 일 년 동안 많은 중학교에서 <span class="green">&quot;중학생이 꼭 알아야 할 고사성어&quot;</span>			학습프로그램으로 고사성어를 열심히 공부한 학생들은 진단평가에서 높은 성적을 거두는 것으로 보고되고 있습니다.		</p>	</div></div><div id="nav">	<button class="next" ng-click="vm.next()" ng-show="vm.page == 1">다음</button></div>';
    })(s06.preexam || (s06.preexam = {}));
    var preexam = s06.preexam;
})(s06 || (s06 = {}));
var Eun;
(function (Eun) {
    Eun.root;
