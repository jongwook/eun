...
(function (s01) {
    (function (welcome) {
        welcome.html = '<div id="nav">	<button class="next" ng-click="vm.next()">다음</button></div><div id="slide" class="large-text">	<p>		안녕하세요, 여러분! <br>		만나서 반갑습니다.	</p>	<p>		여러분은 지금부터 서울대학교 인지학습연구회에서 선정한<br>		<span class="pink">&quot;중학생이 꼭 알아야 할 고사성어&quot;</span>를 학습하게 될 것입니다.	</p>	<p>		학습을 시작하기에 앞서<br>		40개의 문항에 대해 여러분의 솔직한 답변을 부탁드립니다.	</p></div>';
...
(function (s04) {
    (function (prep) {
        prep.html = '<div id="nav">	<button class="prev" ng-click="vm.prev()" ng-show="vm.page > 0 && vm.page < 4">이전</button>	<button class="next" ng-click="vm.next()" ng-show="vm.page < 4">다음</button></div><div id="slide" class="large-text">	<div ng-show="vm.page == 0">		<p>			오늘 여러분이 학습할 고사성어는 중학교 국어 및 한문 교과서에서 자주 다루는 수업 내용으로			<span class="pink">&quot;중학생이 꼭 알아야 할 고사성어&quot;</span>로 선정되어 있으며			전국적으로 실시되는 하업능력평가에서도 많은 비중을 차지하기 때문에 고사성어를 학습하는 것은 매우 중요합니다.		</p>		<p>			지난 일 년 동안 많은 중학교에서 <span class="pink">&quot;중학생이 꼭 알아야 할 고사성어&quot;</span>			학습프로그램으로 고사성어를 열심히 공부한 학생들은 진단평가에서 높은 성적을 거두는 것으로 보고되고 있습니다.		</p>	</div>	<div ng-show="vm.page == 1">		<p>			여러분들은 지금부터 <span class="pink">12분 동안</span><br>			<span class="pink">&quot;중학생이 꼭 알아야 할 고사성어&quot;</span> 학습프로그램을 통해<br>			고사성어를 학습하게 됩니다.		</p>		<p>			학습하고 난 후에는<br>			스피드 퀴즈를 통해 자신의 이해를 점검하게 됩니다.		</p>	</div>	<div ng-show="vm.page == 2">		<p>			스피드퀴즈는 <span class="big pink">총 20문제</span>로 이루어져 있으며,<br>			10분 동안 화면에 주어지는 문제를 보고<br>			정답을 선택하면 됩니다.		</p>		<p>			<span class="blue">정답</span>을 선택할 경우 <span class="blue">5점</span>을 획득하지만,			<span class="red">오답</span>을 선택할 경우 <span class="red">2점</span>을 잃게 됩니다.		</p>	</div>	<div ng-show="vm.page == 3">		<p>			오늘 수업에서 여러분의 목표는		</p>		<p>			중학생들이 <span class="big pink">꼭</span> 알아야 할 <span class="big pink">고사성어에 대해 배우고</span>		</p>		<p>			<span class="big">과제를 수행하며</span> <span class="big pink">완전히 이해하는 것</span>입니다.		</p>	</div>	<div ng-show="vm.page == 4">		<p style="text-align: center;">			과제를 통한 새로운 학습방법으로 <span class="big pink">재미있게</span> 학습해 보세요.<br><br>			<button ng-click="vm.next()" style="width: 600px; height: 50px; background-color: green; color: white; font-size: 18pt; border: 0;">				고사성어 학습하기			</button>		</p>	</div></div>';
    })(s04.prep || (s04.prep = {}));
    var prep = s04.prep;
})(s04 || (s04 = {}));
var s05;
(function (s05) {
    (function (study) {
        study.html = '<div id="nav">	<button class="prev" ng-click="vm.prev()" ng-show="vm.stage > 0 || vm.page > 0">이전</button>	<button class="next" ng-click="vm.next()">다음</button></div><div id="slide" class="study">	<div ng-show="vm.page == 0" class="large-text">		<p>			{{vm.stage + 1}}. {{vm.idioms[vm.stage].title}}		</p>		<table class="cover">			<tr>				<th ng-repeat="letter in vm.idioms[vm.stage].letters[0] track by $index">{{letter}}</th>			</tr>			<tr>				<td ng-repeat="letter in vm.idioms[vm.stage].letters[1] track by $index" ng-bind-html="letter"></td>			</tr>		</table>	</div>	<div ng-show="vm.page == 1" class="small-text">		<br>		<div class="pink-box" ng-bind-html="vm.idioms[vm.stage].story"></div>	</div>	<div ng-show="vm.page == 2" class="small-text">		<br>		<table class="header">			<tr>				<th ng-repeat="letter in vm.idioms[vm.stage].letters[0] track by $index">{{letter}}</th>			</tr>			<tr>				<td ng-repeat="letter in vm.idioms[vm.stage].letters[1] track by $index" ng-bind-html="letter"></td>			</tr>		</table>		<br>		<div ng-bind-html="vm.idioms[vm.stage].description[vm.page-2]"></div>	</div>	<div ng-show="vm.page > 2" class="small-text">		<p>&nbsp;</p>		<div ng-bind-html="vm.idioms[vm.stage].description[vm.page-2]"></div>	</div>	<div class="timer">		<div class="hider" style="background: white; width: 100%; height: {{vm.hide * 50 / 100}}px;"></div>	</div></div>';
    })(s05.study || (s05.study = {}));
    var study = s05.study;
})(s05 || (s05 = {}));
var s06;
    ...
    var QuizController = (function () {
        function QuizController($scope, $location, $sce) {
            ...
            this.problems = [
                ...
                {
                    type: MULTIPLE,
                    question: "<em>번듯하고 그럴듯한 것모습이나 말로 남을 현혹할 때</em>를 뜻하는 고사성어를 <u>모두</u> 고르시오",
                ...
                {
                    type: MULTIPLE,
                    question: "수준이 서로 엇비슷한 사이를 나타내는 말로 <em>우열을 가릴 수 없다</em>를 뜻하는 고사성어를 <u>모두</u> 고르시오",
            ...
            this.idioms = [
                ...
                },
                {
                    ...
                    "description": [
                        ...
                        "자신을 찾아와서 각각 자기의 손을 들어 달라고 손자들의 진식은 질문에 껄껄 웃으며 “너희들의 아버지는 나이를 따진다면 분명 형제간이지만, 두 사람 모두 훌륭하여 학문이나 사람됨에 있어서 ‘형을 형이라 하기도 어렵고 아우를 아우라 하기도 어렵구나.’ 이처럼 ‘난형난제(難兄難弟)’란 <em>누가 형인지 동생인지 분간하기 어려울 만큼, 두 사물이 비슷하여 낫고 못함을 정하기 어려움</em>을 뜻하는 말입니다. "
                    ]
                },
                {
                    "title": "양두구육",
    ...
    var SurveyController = (function () {
        function SurveyController($scope, $location, $sce) {
            ...
            this.questions = [
                ...
                "나는 아무 것도 하지 않는 것보다는 실수하는 것을 더 선소했다.",
