...
(function (s01) {
    (function (welcome) {
        welcome.html = '<div id="slide" class="large-text">	<p>		안녕하세요, 여러분! <br>		만나서 반갑습니다.	</p>	<p>		여러분은 지금부터 서울대학교 인지학습연구회에서 선정한<br>		<span class="green">&quot;중학생이 꼭 알아야 할 고사성어&quot;</span>를 학습하게 될 것입니다.	</p>	<p>		학습을 시작하기에 앞서<br>		40개의 문항에 대해 여러분의 솔직한 답변을 부탁드립니다.	</p></div><div id="nav">	<button class="next" ng-click="vm.next()">다음</button></div>';
