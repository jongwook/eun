...
(function (Eun) {
    var StarterController = (function () {
        function StarterController($scope, $location, type, feedback, group, study) {
            $scope.vm = this;
