module Eun {
	...
	export class StudyController {
		...
		constructor(private $scope, private $location, private $sce, public group, private submit, private elementary) {
			$scope.vm = this;
			...
			this.timer = setInterval(() => {
				if (self.hide < 100) {
					...
					$scope.$apply(() => self.$location.path("/standby").replace());
				}
			}, 1000);
		}
